(function (root,factory) {
  ...
  var watermarkDom = null;
  var recordOldValue = { width: 0, height: 0 };
  ...
  var loadMark = function(settings) {
    ...
    if (defaultSettings.watermark_parent_width || defaultSettings.watermark_parent_height) {
      if (parentEle) {
    ...
    if (hasObserver && defaultSettings.monitor) {
      if (watermarkDom) {
      ...
      if (otdiv.shadowRoot) {
        watermarkDom.observe(otdiv.shadowRoot, option);
      }
    }
  };
